...
\[
  ...
  \left(\feqAA\PS\kk\ii(\xx) \limp \slee\kk(\xx, \yy)\right).
\]
\end{definition}
...
$\StrAp \vDash
 \left(\forall\xx\forall\yy \see\ii(\xx,\yy) \lequ \feg\LS\ii(\xx,\yy)\right)$
by definition.
...
and $\Lvp\aL21\Eea\nosze\ag$ for $\ag \in \set{\agglobal, \agrefine}$.
