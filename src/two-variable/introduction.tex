...
implementing our approach: we look at the different classes (\emph{galaxies}) of
the coarsest equivalence symbol in a model, we transform them into instances of the simpler
