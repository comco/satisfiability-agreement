...
\begin{itemize}
  ...
  under inversion.
  By~\Cref{rem:tpi-sub}, $\Tpi\TpiP\TpiTp$ is also a type instance over $\SigS$.
  ...
  By~\Cref{rem:stp-sub}, every star-type $\stps \in \Cert$ is also a star-type
  over $\Tpi\TpiP\TpiTp$.
