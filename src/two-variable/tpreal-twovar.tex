...
A $\ClSig\SigS\sms$-structure $\StrA$ \emph{realizes} $\Tpi\TpiP\TpiT$ if
$\tpIa\StrA\ea \in \TpiP$ for all $\ea \in \domA$ and $\tpIab\StrA\ea\eb \in
\TpiT$ for all $\ea \in \domA$ and $\eb \in \domA \sub \set{\ea}$.
